...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2018 at 09:47 AM
...
(1, 3, 1, 'Software Eng 1'),
(2, 4, 1, 'Software Eng 2 ');
...
(1, 1234, 'hesham.elalawy@gmail.com', '94ae0a96d83a445d72a93417b63ac90d79db5eca', 'Hesham', 'Elalawy', '0000-00-00', NULL, NULL, 1, 4);
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `fk_courses_division1` FOREIGN KEY (`division_id`) REFERENCES `division` (`division_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_courses_grade` FOREIGN KEY (`grade_id`) REFERENCES `grade` (`grade_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `courses_has_exam`
--
ALTER TABLE `courses_has_exam`
  ADD CONSTRAINT `fk_courses_has_exam_courses1` FOREIGN KEY (`courses_id`) REFERENCES `courses` (`course_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_courses_has_exam_exam1` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `exam_has_questions`
  ADD CONSTRAINT `fk_exam_has_questions_exam1` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
