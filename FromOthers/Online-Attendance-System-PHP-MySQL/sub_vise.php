          ...
          <thead>
              <tr>
               ...
               <tr>
                   ...
                   <td><b>Select Division :<select class="form-control" id="division" name="division" >
                          </select></b>
                   </td>
               </tr>                       
          </thead>
          <tr><td colspan="5"><center>
                   <button type="submit" id="sub_rep_submit" name="sub_rep_submit" value="submit"  class="btn btn-primary"style="height: 100%; width: 30%;" >Generate Report</button>
                   </center> </td></tr> 
</table>
</form>
</div>
