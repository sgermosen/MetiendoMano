...
{
    public class AbstractDAO<TCommand, TConnection, TAdapter> : IDisposable
        ...
        where TAdapter : DbDataAdapter, new()
    {
        ...
        public AbstractDAO(InstanceType ContainerInstance = InstanceType.SqlServer)
        {
            this.ContainerInstance = ContainerInstance;
            Connection = (TConnection)Activator.CreateInstance(typeof(TConnection), ConnString);
            commandType = CommandType.Text;
        ...
        public AbstractDAO(string ConnString)
        {
            this.ContainerInstance = InstanceType.Oracle;
            Connection = (TConnection)Activator.CreateInstance(typeof(TConnection), ConnString);
            commandType = CommandType.Text;
        }
        ...
        public virtual void FillCommand(string sqlCommand, Object[] values = null, Object[] paramDirs = null)
        {
            this.FillCommand(sqlCommand, values, paramDirs, false, null);
        }
        ...
        public virtual void FillCommandP(string procedureName, Object[] values, String parameterNames, Object[] paramDirs = null)
        {
